...
void a7prepMaterials2(Material** materials) {
    ...
    //materials[3] = new CookTorrance(whitetex, whitetex, 3.433f, 8.485f, 0.2f);
...
void a7prepMaterials3(Material** materials) {
    ...
    //green->add(new CookTorrance(greentex, blacktex, 3.433f, 2.485f, 0.2f), 0.5f);
    ...
    //CookTorrance* cook = new CookTorrance(whitetex, whitetex, 3.433f, 8.485f, 0.2f);
...
void a_materials() {
    ...
    //a7renderCornellbox(0.001f, "a6-1b-cookt.png", materials);
    a7renderCornellbox(0.001f, "a6-1b.png", materials);
    a7prepMaterials3(materials);
    //a7renderCornellbox(0.001f, "a6-1c-cookt.png", materials);
